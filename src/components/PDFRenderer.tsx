...
const PDFRenderer = ({ url }: PdfRendererProps) => {
  ...
  type TCustomPageValidator = z.infer<typeof CustomPageValidatior>;
  ...
  const {
    ...
    resolver: zodResolver(CustomPageValidatior),
  });
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button className="gap-1.5" aria-label="Zoom" variant="ghost">
                ...
                {scale * 100}% <ChevronDown className="w-4 h-4 opacity-50" />
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent>
